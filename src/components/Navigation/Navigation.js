      ...
      <nav className={`navigation ${props.open ? 'navigation_mobile-opened' : props.theme ? 'navigation_theme_dark' : ''}`}>
        <ul className='navigation__list'>
            <Route exact path='/'>
              ...
              <li>{props.loggedIn ? <button className='navigation__btn' onClick={logOut}>{name}<img className='navigation__logout' src={logoutImg} alt='иконка кнопки выхода'/></button> : <button className='navigation__btn' onClick={openLoginPopup}>Авторизироваться</button>}</li>
            </Route>
            <Route exact path='/saved-news'>
              ...
              <li>{props.loggedIn ? <button className='navigation__btn navigation__btn_black' onClick={logOut}>{name}<img className='navigation__logout' src={logoutBlack} alt='иконка кнопки выхода'/></button> : <button className='navigation__btn' onClick={openLoginPopup}>Авторизироваться</button>}</li>
            </Route>
          </ul>
      </nav>
  )
